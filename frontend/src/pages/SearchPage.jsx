    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="space-y-1">
        {results.map((job) => (
          <div key={job.job_id} className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
            <Link to={`/job/${job.job_id}`} className="block p-1">
              <div className="flex justify-between items-start mb-2">
                <div className="flex-1">
                  <h3 className="text-lg font-semibold leading-tight text-gray-900 hover:text-blue-600">
                    {job.title}
                  </h3>
              ...
              <div className="flex items-center gap-1 text-sm text-gray-500 mb-1">
                <span className="flex items-center">
                  <svg className="w-[1em] h-[1em] mr-1" fill="none" stroke="currentColor" viewBox="0 0 256 256">
      ...
      {!loading && results.length === 0 && (
        <div className="text-center py-12">
          <svg className="mx-auto h-4 w-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 256 256">
